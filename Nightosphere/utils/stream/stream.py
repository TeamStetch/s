...
import config
from Nightosphere import Carbon, YouTube, app
from Nightosphere.core.call import NightoX
from Nightosphere.misc import db
from Nightosphere.utils.database import (add_active_video_chat,
                                      is_active_chat,
                                      is_video_allowed)
from Nightosphere.utils.exceptions import AssistantErr
from Nightosphere.utils.inline.play import (stream_markup,
                                         telegram_markup)
from Nightosphere.utils.inline.playlist import close_markup
from Nightosphere.utils.pastebin import NightoXbin
from Nightosphere.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await NightoX.force_stop_stream(chat_id)
